...
-- Volcando estructura para tabla crud_python.consignaciones
CREATE TABLE IF NOT EXISTS `consignaciones` (
  `id` int NOT NULL AUTO_INCREMENT,
  `valor_consignacion` bigint NOT NULL,
  `name_archivo` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `url_archivo` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nota_consignacion` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `estatus_leido` tinyint(1) DEFAULT '0',
  `bandeja` bigint DEFAULT '0',
  `code_tienda` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ip_consignacion` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nombre_tienda` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_consignacion_ignorada` int DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla crud_python.consignaciones: ~10 rows (aproximadamente)

-- Volcando estructura para tabla crud_python.detalles_consignaciones
...
-- Volcando datos para la tabla crud_python.detalles_consignaciones: ~14 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `tbl_empleados` (
  ...
  `profesion_empleado` int DEFAULT NULL,
  `foto_empleado` mediumtext,
  `cargo_empleado` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla crud_python.tbl_empleados: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla crud_python.users: ~1 rows (aproximadamente)
